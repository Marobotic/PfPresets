    ...
    public partial class PluginUI
    {
        ...
        private static readonly ChangeEntry[] Changelog =
        {
            new("3.5.1.1", "August 2026", new[]
            {
                ...
                "Clears has two tabs: Broadcast, the feed of everybody's clears as before, and My clears, every clear of your own that has gone up on it. My clears appears with your first clear.",
